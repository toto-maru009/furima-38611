class PurchaseBuyer
  ...
  def save
    ...
    #住所の保存
    Buyer.create(postal_code: postal_code, :municipality municipality, :address address, :building_name building_name, :telephone_number telephone_number, :prefecture_id prefecture_id purchase_id: purchase_id)
  end
end